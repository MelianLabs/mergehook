class GithubWebhooksController < ActionController::Base
  ...
  def push(payload)
    ...
    client.create_status @project.repo, payload[:after], "success", {:target_url => "https://mymergehook.herokuapp.com/projects/#{@project.id}/trigger_build/#{branch}", :context => "Trigger Build"}
